        ...
        <div className="policy-root">
            ...
            <div className="policy-view">
                <div className="policy-main">
                    ...
                    <div className="policy-main-help-text-wrap">
                        <p>
                            {`Your privacy is important to us. It is the City Of Mars Org's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, `}
                            <a href="https://cityofmars.net">https://cityofmars.net</a>
                            {`, and other sites we own and operate.`}
                        </p>
                        <p>
                            {`Personal information is any information about you which can be used to identify you. This includes information about you as a person (such as name, address, and date of birth), your devices, payment details, and even information about how you use a website or online service.`}
                        </p>
                        <p>{`This policy is effective as of 10 April 2022.`}</p>
                        <p>{`Last updated: 10 April 2022`}</p>
                    </div>
                    <div className="policy-main-subtitle-wrap">
                    ...
                    <div className="policy-main-help-text-wrap">
                        <p>City Of Mars Team</p>
                        <p>support@cityofmars.net</p>
                    </div>
                </div>
            </div>
            <Footer />
